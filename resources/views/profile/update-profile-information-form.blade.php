      ...
      <x-slot name="form">
          ...
          @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
              <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                  ...
                  <x-label for="photo" value="{{ __('Avatar') }}" />
                  ...
                  <div class="mt-2" > <!-- x-show="! photoPreview" -->
                      ...
                      @endphp
                      <img src="{{ $avatar_url }}" title="{{ $this->user->name }}" alt="{{ $this->user->name }}" class="rounded-full h-20 w-20 object-cover">
                  </div>
          ...
          <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="address" type="tel" class="mt-1 block w-full" wire:model="state.address" required autocomplete="address" />
