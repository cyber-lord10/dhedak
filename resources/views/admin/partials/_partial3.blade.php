  ...
  <div class="content-wrapper">
          ...
          <div class="card-body py-0 px-0 px-sm-3">
            <div class="row align-items-center">
              ...
              <div class="col-5 col-sm-7 col-xl-8 p-0">
                <h4 class="mb-1 mb-sm-0">General statistics</h4>
                <p class="mb-0 font-weight-normal d-none d-sm-block">Here you'll get an account of everything going on on your website!</p>
              </div>
              <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                <span>
                  <a href="/" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn ms-4">Visit website</a>
                </span>
              </div>
            </div>
          </div>
      ...
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="text-secondary font-weight-normal">Potential growth</h6>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="text-secondary font-weight-normal">Revenue current</h6>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="text-secondary font-weight-normal">Daily Income</h6>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="text-secondary font-weight-normal">Expense current</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-8 col-sm-12 col-xl-8 my-auto">
                ...
                <h6 class="text-secondary font-weight-normal">11.38% Since last month</h6>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-8 col-sm-12 col-xl-8 my-auto">
                ...
                <h6 class="text-secondary font-weight-normal"> 9.61% Since last month</h6>
              </div>
              <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
      ...
      <div class="col-sm-4 grid-margin">
        <div class="card">
          <div class="card-body">
            <h5 class="text-info">Purchase</h5>
            <div class="row">
              <div class="col-8 col-sm-12 col-xl-8 my-auto">
                <div class="d-flex d-sm-block d-md-flex align-items-center">
                ...
                <h6 class="text-secondary font-weight-normal">2.27% Since last month</h6>
              </div>
              <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="pl-2 text-dark">Henry Klein</span>
                    </td>
                    <td> 02312 </td>
                    <td> $14,500 </td>
                    <td> Dashboard </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="pl-2 text-dark">Estella Bryan</span>
                    </td>
                    <td> 02312 </td>
                    <td> $14,500 </td>
                    <td> Website </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="pl-2 text-dark">Lucy Abbott</span>
                    </td>
                    <td> 02312 </td>
                    <td> $14,500 </td>
                    <td> App design </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="pl-2 text-dark">Peter Gill</span>
                    </td>
                    <td> 02312 </td>
                    <td> $14,500 </td>
                    <td> Development </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="pl-2 text-dark">Sallie Reyes</span>
                    </td>
                    <td> 02312 </td>
                    <td> $14,500 </td>
                    <td> Website </td>
