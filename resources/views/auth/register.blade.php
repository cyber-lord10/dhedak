  ...
  <x-authentication-card class="py-4">
    ...
    <div class="container">
      ...
      <x-form :action="route('register')">
        ...
        <x-form-header form_title="Register" />
        ...
        <div>
          ...
          <x-input id="name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" value="{{old('name')}}"/>
          @error('name')
              {{$message}}
          @enderror
        </div>
        ...
        <div class="mt-4">
          ...
          <x-input id="email" type="email" name="email" :value="old('email')" required autocomplete="email" value="{{old('email')}}" />
          @error('email')
              {{$message}}
          @enderror
        </div>
        ...
        <div class="mt-4">
          ...
          <x-input id="phone" type="tel" name="phone" :value="old('phone')" required autocomplete="phone" value="{{old('phone')}}"/>
          @error('phone')
              {{$message}}
          @enderror
        </div>
        ...
        <div class="mt-4">
          ...
          <x-input id="address" type="text" name="address" :value="old('address')" required autocomplete="address" value="{{old('address')}}" />
          @error('address')
              {{$message}}
          @enderror
        </div>
        ...
        <div class="mt-4">
          ...
          <x-input id="password" type="password" name="password" style="-webkit-text-security: circle !important;" required autocomplete="new-password" value="{{old('password')}}" />
          @error('name')
              {{$password}}
          @enderror
        </div> {{--Cyberlord1234# --}}
        ...
        <div class="mt-4">
          ...
          <x-input id="password_confirmation" type="password" name="password_confirmation" style="-webkit-text-security: circle !important;" required autocomplete="new-password" value="{{old('password_confrimation')}}" />
        ...
        {{-- <div class="flex items-center justify-end mt-4"> --}}
          ...
          <div class="text-end">
            <a class="underline text-sm text-secondary" href="{{ route('login') }}">
